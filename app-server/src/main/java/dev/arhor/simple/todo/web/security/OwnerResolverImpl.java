...
public class OwnerResolverImpl implements OwnerResolver {
    ...
    @Override
    public String resolveOwnerId(final Authentication authentication) {
    ...
    private String resolveOwnerIdFromOAuth2Token(final OAuth2AuthenticationToken oAuth2Token) {
